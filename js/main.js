...
const openNav = document.querySelector(".fa-align-justify");
const closeNav = document.querySelector(".open-close-icon");
const loader = document.querySelector(".loading");
const foodsData = document.querySelector("#allFoods");

const search = document.querySelector("#Search");
const searchContainer = document.querySelector(".searchInputs");
const searchBarName = document.querySelector(`[placeholder="Search By Name"]`);
const searchFirstLetter = document.querySelector(
...
const contactText = document.querySelector(".contactForm");
...
async function getApiSearchName(currentFood) {
  ...
  loader.classList.remove("d-none");
  let api = await fetch(
    `https://www.themealdb.com/api/json/v1/1/search.php?s=${currentFood}`
  );
...
function displayIngredients(arr) {
  ...
  for (i = 0; i < arr.length; i++) {
    boxEat =
      ...
      `
            <div class="col-md-3">
            <div class="item text-center" onclick="getApiIngredientsFoods('${
              arr[i].strIngredient
            }')">
